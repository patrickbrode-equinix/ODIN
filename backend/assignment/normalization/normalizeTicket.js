...
import { TYPE_ALIASES, STATUS_ALIASES, PRIORITY_ALIASES } from '../config.js';
...
export function normalizeTicket(raw) {
  ...
  const dateResult = mapDates(
    raw.due_at ?? raw.dueAt ?? raw.commit_date ?? raw.sched_start,
    raw.created_at ?? raw.createdAt ?? raw.created
  );
  ...
  return {
    ...
    customer: raw.customer ?? raw.customer_name ?? null,
